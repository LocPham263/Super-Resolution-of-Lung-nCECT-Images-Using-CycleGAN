...
class PairedRevGAN3dModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        if self.isTrain:
            ...
            self.optimizer_D = torch.optim.Adam(self.netD_AB.parameters(),
                                                lr=opt.lr, betas=(opt.beta1, 0.999))
            self.optimizers = []
    ...
    def backward_D(self):
        ...
        # AB
        self.loss_D_AB = (loss_D_fake_AB + loss_D_real_AB) * 0.5

        # # BA
        # self.loss_D_BA = loss_D_fake_BA + loss_D_real_BA

        # Combined loss
        loss_D = self.loss_D_AB 
    ...
    def backward_G(self):
        ...
        # Combined loss
        self.loss_G = self.loss_G_AB + self.loss_G_L1_B
